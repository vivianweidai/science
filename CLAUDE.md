...
└── archives/               # Shared assets
    ├── CONTENT/            # All data: YAML source + generated JSON + manifests
    ...
    │   ├── curriculum_manifest.json     # Generated by build_curriculum_manifest.py
    │   └── curriculum_highlights.json   # Generated by extract_highlights.py
    ...
    │   ├── build_curriculum_manifest.py # curriculum/*.md → CONTENT/curriculum_manifest.json
    │   ├── extract_highlights.py        # NOTES/*.pdf → CONTENT/curriculum_highlights.json
    │   └── apply_highlights.py          # CONTENT/curriculum_highlights.json → curriculum/*.md
