...
| Tech (row) | `categories[].techs[].tech` | `tech:` | `/research/tech/<sci>/<Tech>/` | `tech` |
| Toy (instrument) | `toys[].name` (under a tech's frontmatter) | `toys:` array | — | — |

`tech.yml` is the source of truth; `tech.json` is generated by `pipeline/scripts/build_tech.py` and consumed by both the Astro pages and the Apple/Android apps.
...
│       ├── olympiads/      # /olympiads/
│       ├── research/       # /research/ + dynamic /research/projects/[slug]/ + /research/tech/[science]/[tech]/
│       └── privacy.md      # /privacy/
│
├── pipeline/
...
│       ├── build_olympiads.py / build_tech.py  # YAML → JSON
...
│       ├── tech.yml              # Source of truth — edit, then rebuild
│       └── tech.json             # Generated — DO NOT EDIT BY HAND
│
