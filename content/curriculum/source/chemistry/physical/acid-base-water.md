...
<tr><td>water</td><td colspan="2">${2H_{2}O}_{(l)} \rightleftharpoons {H_{3}O^{+}}_{(aq)} + {OH^{-}}_{(aq)}$</td></tr>
...
<tr><td>pH</td><td>$pH = - \log\lbrack H^{+}\rbrack$</td><td>shorthand expression</td></tr>
<tr><td>pH</td><td>$pK_{w} = pH + pOH = 14$</td><td>substitution</td></tr>
</table>
