...
All spectra plots, peak identification, and category overlays were generated from the cleaned data using the <a href="https://github.com/vivianweidai/research/blob/main/20260401%20IR%20Spectroscopy/OUTPUT/ir_analysis.ipynb">analysis notebook</a>.
...
<div class="tabs">
  ...
  <div class="tab-content" id="content-acetone">
    <img src="OUTPUT/IMAGES/acetone_spectrum.png" alt="Acetone spectrum" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-water">
    <img src="OUTPUT/IMAGES/water_spectrum.png" alt="Water spectrum" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-salt">
    <img src="OUTPUT/IMAGES/salt_spectrum.png" alt="Salt spectrum" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-plastic">
    <img src="OUTPUT/IMAGES/plastic_bag_spectrum.png" alt="Plastic Bag spectrum" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-sugar">
    <img src="OUTPUT/IMAGES/sugar_spectrum.png" alt="Sugar spectrum" style="width:100%; border-radius:6px;">
...
<div class="tabs">
  ...
  <div class="tab-content" id="content-solvents">
    <img src="OUTPUT/IMAGES/solvents_spectrum.png" alt="Solvents spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-food">
    <img src="OUTPUT/IMAGES/food_minerals_spectrum.png" alt="Food / Minerals spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-personal">
    <img src="OUTPUT/IMAGES/personal_care_spectrum.png" alt="Personal Care spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-polymers">
    <img src="OUTPUT/IMAGES/polymers_spectrum.png" alt="Polymers spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-paper">
    <img src="OUTPUT/IMAGES/paper_spectrum.png" alt="Paper spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-biological">
    <img src="OUTPUT/IMAGES/biological_spectrum.png" alt="Biological spectra" style="width:100%; border-radius:6px;">
...
<div class="tabs">
  ...
  <div class="tab-content" id="content-chem-oh">
    <img src="OUTPUT/IMAGES/chem_oh_spectrum.png" alt="O–H dominant spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-chem-ch">
    <img src="OUTPUT/IMAGES/chem_ch_spectrum.png" alt="C–H dominant spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-chem-co">
    <img src="OUTPUT/IMAGES/chem_co_spectrum.png" alt="Carbonyl spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-chem-mixed">
    <img src="OUTPUT/IMAGES/chem_mixed_spectrum.png" alt="Mixed organic spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-chem-cellulose">
    <img src="OUTPUT/IMAGES/chem_cellulose_spectrum.png" alt="Cellulose spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-chem-protein">
    <img src="OUTPUT/IMAGES/chem_protein_spectrum.png" alt="Protein / amide spectra" style="width:100%; border-radius:6px;">
  ...
  <div class="tab-content" id="content-chem-ionic">
    <img src="OUTPUT/IMAGES/chem_ionic_spectrum.png" alt="Ionic spectra" style="width:100%; border-radius:6px;">
