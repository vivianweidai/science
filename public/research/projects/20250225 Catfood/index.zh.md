...
原始数据记录在手写数据表上并拍照。每次实验追踪的变量包括：日期、份数、投放和剩余粒数、碗的位置（左/右）、进食时间和色素滴数。原始手写数据表的照片可在<a href="https://github.com/vivianweidai/science/tree/main/public/research/projects/20250225%20Catfood/photos/data" rel="noopener">data</a>中查看。偏好计数从手写记录转录到<a href="https://github.com/vivianweidai/science/blob/main/public/research/projects/20250225%20Catfood/output/catfood_summary.csv" rel="noopener">catfood_summary.csv</a>。

<div class="photo-grid three-col" id="data-grid">
  <img src="photos/data/data1.jpeg" alt="数据表">
  <img src="photos/data/data2.jpeg" alt="数据表">
  <img src="photos/data/data3.jpeg" alt="数据表">
</div>
...
查看<a href="https://github.com/vivianweidai/science/blob/main/public/research/projects/20250225%20Catfood/output/20250225%20Catfood.pdf" rel="noopener">书面报告</a>、<a href="https://github.com/vivianweidai/science/blob/main/public/research/projects/20250225%20Catfood/output/catfood_analysis.ipynb" rel="noopener">静态笔记本</a>或<a href="https://colab.research.google.com/github/vivianweidai/science/blob/main/public/research/projects/20250225%20Catfood/output/catfood_analysis.ipynb" rel="noopener">自行运行可重复分析</a>。
