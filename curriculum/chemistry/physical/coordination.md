...
<tr><td>coordination</td><td>$Ag(H_{2}O)_{6}^{+} + NH_{3} \rightleftharpoons Ag(NH_{3})(H_{2}O)_{5}^{+}$ $\beta_{2} = K_{1}K_{2}$</td><td></td></tr>
...
<tr><td>mole fraction</td><td>$C_{0} = \lbrack Ag^{+}\rbrack + \lbrack Ag(NH_{3})^{+}\rbrack + \lbrack Ag(NH_{3})_{2}^{+}\rbrack$</td><td></td></tr>
<tr><td>mole fraction</td><td>$C_{0} = \lbrack Ag^{+}\rbrack\left( 1 + \beta_{1}\lbrack NH_{3}\rbrack + \beta_{2}\lbrack NH_{3}\rbrack^{2} \right)$</td><td></td></tr>
