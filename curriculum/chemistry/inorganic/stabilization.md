...
<tr><td>stabilization</td><td>$\Delta\text{vs}P$ split vs pairing</td><td>Aufbau pairs or split electrons</td></tr>
<tr><td>stabilization</td><td>strong field low spin Aufbau</td><td>weak field high spin split</td></tr>
<tr><td>stabilization</td><td>$d^{4}t_{2g}^{3}e_{g}^{1}\frac{3}{5}\Delta_{o}t_{2g}^{4}\frac{8}{5}\Delta_{o} - P$</td><td>energy relative to unsplit state</td></tr>
