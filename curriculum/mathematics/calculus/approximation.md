...
|-------|-------------------|-------------|
| approximation | estimate function | near a point |
| approximation | quadratic match derivatives | solve equal coefficients |
| approximation | $p(x) = f(a) + f'(a)(x - a) + \frac{f^{''}(a)}{2}(x - a)^{2}$ |  |
| approximation | error versus actual | bound by next term |
